...
############################################################
t_00 = tlibrary.words('00.alice.txt')
t_01 = tlibrary.words('01.kerry.txt')
t_02 = tlibrary.words('02.cathie.txt')
t_03 = tlibrary.words('03.dave.txt')
t_04 = tlibrary.words('04.marie.txt')
t_05 = tlibrary.words('05.peter.txt')
t_06 = tlibrary.words('06.emily.txt')
t_07 = tlibrary.words('07.gaia.txt')
t_08 = tlibrary.words('08.steph.txt')
t_09 = tlibrary.words('09.cherry.txt')
t_10 = tlibrary.words('10.diana.txt')
t_11 = tlibrary.words('11.donna.txt')
t_12 = tlibrary.words('12.amanda.txt')
t_13 = tlibrary.words('13.peter.txt')
############################################################
...
t_dict = defaultdict(lambda: defaultdict(list))
...
setupcorpus(t_00, en_stop, t_dict, 't'), print('added 00 - TE')
setupcorpus(t_01, en_stop, t_dict, 't'), print('added 01 - TE')
setupcorpus(t_02, en_stop, t_dict, 't'), print('added 02 - TE')
setupcorpus(t_03, en_stop, t_dict, 't'), print('added 03 - TE')
setupcorpus(t_04, en_stop, t_dict, 't'), print('added 04 - TE')
setupcorpus(t_05, en_stop, t_dict, 't'), print('added 05 - TE')
setupcorpus(t_06, en_stop, t_dict, 't'), print('added 06 - TE')
setupcorpus(t_07, en_stop, t_dict, 't'), print('added 07 - TE')
setupcorpus(t_08, en_stop, t_dict, 't'), print('added 08 - TE')
setupcorpus(t_09, en_stop, t_dict, 't'), print('added 09 - TE')
setupcorpus(t_10, en_stop, t_dict, 't'), print('added 10 - TE')
setupcorpus(t_11, en_stop, t_dict, 't'), print('added 11 - TE')
setupcorpus(t_12, en_stop, t_dict, 't'), print('added 12 - TE')
setupcorpus(t_13, en_stop, t_dict, 't'), print('added 13 - TE')
...
def get_results(words, algo, dic):
    ...
    for r in words:
        ...
        if dic == 'shakespeare': files = s_dict[r]
        if dic == 'tettt': files = t_dict[r]
...
def clinamen(w, c, i):
    ...
    # with open("thesis.txt", "a") as mylog:
        ...
        # mylog.write(f)
        # mylog.write('\n')
    # print('inside clinamen function: out:', out)
    # print('inside clinamen function: words:', words)
    # print('inside clinamen function: sources:', sources)
    # print('inside clinamen function: total:', total)
...
def antinomy(w, c):
    ...
    # print('inside antinomy function: ', words)
    return out, words, sources, total
